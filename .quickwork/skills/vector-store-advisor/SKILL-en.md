...
> Note: The test results below are based on topK=10, m=16, ef_construction=200, ef_search ranging 40-100.
> If the customer's parameters differ (e.g., larger topK or higher ef_search), actual performance will vary —
> General rules: topK↑ latency↑, ef_search↑ recall↑ but latency↑, m↑ larger index but higher recall.
